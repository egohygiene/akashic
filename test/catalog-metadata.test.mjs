...
const official = { metadata: { authority: "official", access: ["free", "eligibility-based"], geography: ["us-ma"], authorization: ["reference-only", "explicit-scope"], operationalRisk: "low", skillLevel: "mixed", artifactDomain: ["disk", "memory"], forensicRole: ["acquisition", "analysis"] } };
