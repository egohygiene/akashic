...
function resourceCard(resource, index) {
  ...
  const metadataRows = [
    ...
    [t("runtime.metadata.authorization"), metadata.authorization?.join(", "), true, true],
    [t("runtime.metadata.operationalRisk"), metadata.operationalRisk, true, true],
    [t("runtime.metadata.skillLevel"), metadata.skillLevel, true, true],
